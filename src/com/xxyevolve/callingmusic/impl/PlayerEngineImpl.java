package com.xxyevolve.callingmusic.impl;
...
import com.xxyevolve.callingmusic.dao.IPlayerEngine;
...
public class PlayerEngineImpl implements IPlayerEngine {
	...
	private FileDescriptor fDpath = null;
	...
	@Override
	public void play(FileDescriptor fDPath) {
		mediaPlayerEngine.play(fDPath);
	}
	...
	@Override
	public void setPlayingPath(FileDescriptor path) {
		this.fDpath  = path;
	}
